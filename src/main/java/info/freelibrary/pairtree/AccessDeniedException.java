 ...
 */
public class AccessDeniedException extends PairtreeException {
     ...
     */
    public AccessDeniedException(final String aMessageCode) {
        super(aMessageCode);
    }
     ...
     */
    public AccessDeniedException(final String aMessageCode, final Object... aDetailsArray) {
     ...
     * @param aMessageCode A message code
     */
    public AccessDeniedException(final Throwable aCause, final String aMessageCode) {
